...
| --- | --- | --- |
| [`AppShell`](/docs/reference/components/application-shell/app-shell) | `function AppShell` | Public function AppShell. |
| [`AppBar`](/docs/reference/components/application-shell/app-bar) | `function AppBar` | Public function AppBar. |
| [`StatusBar`](/docs/reference/components/application-shell/status-bar) | `function StatusBar` | Public function StatusBar. |
