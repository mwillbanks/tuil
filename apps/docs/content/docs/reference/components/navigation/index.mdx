...
| --- | --- | --- |
| [`Tabs`](/docs/reference/components/navigation/tabs) | `function Tabs` | Public function Tabs. |
| [`Menu`](/docs/reference/components/navigation/menu) | `function Menu` | Public function Menu. |
| [`Menubar`](/docs/reference/components/navigation/menubar) | `function Menubar` | Public function Menubar. |
| [`Breadcrumbs`](/docs/reference/components/navigation/breadcrumbs) | `function Breadcrumbs` | Public function Breadcrumbs. |
| [`Stepper`](/docs/reference/components/navigation/stepper) | `function Stepper` | Public function Stepper. |
| [`TabSelect`](/docs/reference/components/navigation/tab-select) | `constant TabSelect` | Public constant TabSelect. |
| [`Pagination`](/docs/reference/components/navigation/pagination) | `function Pagination` | Public function Pagination. |
| [`Outline`](/docs/reference/components/navigation/outline) | `function Outline` | Public function Outline. |
