...
import { tableStory as ComponentStory } from '@/components/reference-stories.story';
...
| Export | Kind | Source |
| --- | --- | --- |
| `Table` | function | `registry/data-display/complex-data.tsx` |
| `DataTable` | function | `registry/data-display/complex-data.tsx` |
