...
| Export | Kind | Source |
| --- | --- | --- |
| `protocolLimits` | constant | `packages/protocol/src/index.ts` |
| `ProtocolMessageType` | type | `packages/protocol/src/index.ts` |
| `protocolRedactedValue` | constant | `packages/protocol/src/index.ts` |
| `protocolVersion` | constant | `packages/protocol/src/index.ts` |
